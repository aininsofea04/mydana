...
import {
  ...
  FlatList, Alert, TextInput, ActivityIndicator, Image, Dimensions, ImageBackground
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 24, paddingVertical: 14, backgroundColor: 'transparent'
  },
  ...
  sectionSub: { fontSize: 13, color: COLORS.textSecondary, marginTop: 10, lineHeight: 20, marginBottom: 20 },
  searchBox: {
    flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(255, 255, 255, 0.85)',
    borderRadius: 12, paddingHorizontal: 16, height: 54, borderWidth: 1.5, borderColor: COLORS.borderLight, marginBottom: 20
  },
  searchInput: { flex: 1, fontSize: 14, color: COLORS.text },
  filterRow: { flexDirection: 'row', gap: 8, marginBottom: 20 },
  filterChip: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.5)', borderWidth: 1, borderColor: COLORS.borderLight },
  filterChipActive: { backgroundColor: COLORS.textMuted },
  ...
  advancedFilterText: { fontSize: 13, fontWeight: '700', color: COLORS.textMuted },
  aiSummaryCard: {
    backgroundColor: COLORS.textMuted, borderRadius: 24, padding: 24, alignItems: 'center', marginBottom: 30,
    shadowColor: COLORS.textMuted, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 10
  },
  ...
  appCard: { backgroundColor: 'rgba(255, 255, 255, 0.85)', borderRadius: 24, padding: 16, marginBottom: 20, borderWidth: 1.5, borderColor: COLORS.borderLight },
  ...
  miniAvatarText: { fontSize: 10, fontWeight: '800', color: COLORS.textSecondary },
  detailBtn: { backgroundColor: COLORS.textMuted, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10 },
